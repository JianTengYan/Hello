...
#3. Add a half-poin if the team that is ahead has the ball.
#and subtract a half-oint if the other team has the ball.
...
if lead_calculation_float < 0:
	lead_calcuation_float = 0
	
#4. Square that.
lead_calculation_float = lead_calculation_float **2

#5. If the results is greater than the number of seconds left in the game, the lead is safe.
